    ...
    <div className="container mx-auto px-4 py-16 md:px-6 md:py-24">
      ...
      >
        ...
        <motion.div
          ...
          className="bio-card bg-card rounded-xl p-6 shadow-lg border mb-12 relative overflow-hidden"
        >
          {/* Decorative elements */}
          ...
          <div className="relative">
            ...
            <p className="text-lg mb-6">
              I'm a full-stack developer who loves turning ideas into reality. When 
              I'm not debugging, I'm probably sketching or watching sci-fi series.
            </p>
            <p className="text-lg">
        ...
        >
          <div className="journey-card bg-card rounded-xl p-6 shadow-lg border relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="space-y-4">
                <div className="border-l-2 border-primary pl-4 py-2">
                  <h3 className="font-medium">Started coding in 2020</h3>
                  <p className="text-muted-foreground">
                    Fell in love with JavaScript and built my first website
                  </p>
                </div>
                <div className="border-l-2 border-primary pl-4 py-2">
                  <h3 className="font-medium">Mastered React in 2022</h3>
                  <p className="text-muted-foreground">
                    Started working with backend with logical skills.
                  </p>
                </div>
                <div className="border-l-2 border-primary pl-4 py-2">
                  <h3 className="font-medium">Full-stack by 2024</h3>
                  <p className="text-muted-foreground">
                    Added React.js to my toolkit and never looked back
                  </p>
                </div>
                <div className="border-l-2 border-primary pl-4 py-2">
          ...
          <div className="not-coding-card bg-card rounded-xl p-6 shadow-lg border relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start">
                  ...
                  <span>Solving OOPs Problems on Leetcode.</span>
                </li>
                <li className="flex items-start">
                  <span className="inline-flex items-center justify-center w-6 h-6 mr-3 bg-primary/20 rounded-full text-primary">📺</span>
                  <span>Watching animated or real-action movies and series</span>
                </li>
                <li className="flex items-start">
                  <span className="inline-flex items-center justify-center w-6 h-6 mr-3 bg-primary/20 rounded-full text-primary">🎮</span>
